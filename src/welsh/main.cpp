// this file original copy from https://github.com/aman-bhatia/Computer-Vision-Final-Project/blob/master/color-transfer/src/main.cpp
#include <iostream>
#include <vector>
#include <time.h>
...
Mat colorize(Mat &reference, Mat &grey){
	Mat result(grey.rows , grey.cols , CV_8UC3);
